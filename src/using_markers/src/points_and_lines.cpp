...
// Description: Teaches how to use the visualization_msgs/Marker message to
// send points and lines to rviz.
// source:
...
int main(int argc, char *argv[])
{
  ...
  while (ros::ok())
  {
    ...
    // LINE_STRIP/LINE_LIST marker use only the x component of scale, for the
    // line width
